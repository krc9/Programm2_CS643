...
import static com.krc9.wineproject.ConstantsVars.*;
...
public class TrainingModel {
    ...
    public void showModelMetrics(Dataset<Row> predictions) {
        System.out.println();
        MulticlassClassificationEvaluator evaluator = new MulticlassClassificationEvaluator();
        evaluator.setMetricName("accuracy");
        System.out.println("Model Accuracy is " + evaluator.evaluate(predictions));
